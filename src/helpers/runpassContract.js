...
export const runpasscontractAddress = '0xafc079c8bbc8f0a2d1fc4fdd283c0bc3283f5d11';

export const getrunpassContract = (library, account) => {

    // console.log('contract library', library)
    // console.log('contract account', account)
	const signer = library.getSigner(account).connectUnchecked();
	var contract = new Contract(runpasscontractAddress, contractAbi, signer);
	return contract;
};
